...
class CitaControllerTest < ActionController::TestCase
  ...
  test "should create citum" do
    assert_difference('Citum.count') do
      post :create, citum: { Anotaciones: @citum.Anotaciones, Fecha: @citum.Fecha, Motivo: @citum.Motivo }
    end
  ...
  test "should update citum" do
    patch :update, id: @citum, citum: { Anotaciones: @citum.Anotaciones, Fecha: @citum.Fecha, Motivo: @citum.Motivo }
    assert_redirected_to citum_path(assigns(:citum))
  end
