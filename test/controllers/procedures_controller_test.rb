...
class ProceduresControllerTest < ActionController::TestCase
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post :create, procedure: { appointment_id: @procedure.appointment_id, descripcion: @procedure.descripcion, nombre: @procedure.nombre, precio: @procedure.precio, tipo: @procedure.tipo }
    end
  ...
  test "should update procedure" do
    patch :update, id: @procedure, procedure: { appointment_id: @procedure.appointment_id, descripcion: @procedure.descripcion, nombre: @procedure.nombre, precio: @procedure.precio, tipo: @procedure.tipo }
    assert_redirected_to procedure_path(assigns(:procedure))
  end
